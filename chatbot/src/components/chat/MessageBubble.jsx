          ...
          {!isEditing && !isRegenerating && (
            <div className="relative" ref={menuRef}>
              <button
                ...
                className={`opacity-0 group-hover:opacity-100 transition-all duration-200 p-1 rounded hover:bg-opacity-20 hover:bg-gray-500 ${isUser ? 'text-mint-200 hover:text-white' : 'text-gray-400 hover:text-gray-600'
                  }`}
                title="Tùy chọn"
              >
